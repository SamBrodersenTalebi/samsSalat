...
import ægOgRejser from '../images/salatbillede.jpeg';
import menu from '../images/pasta.jpeg';
import salatBar from '../images/salatshirazi.jpeg';
          ...
          <Col lg={6} md={12} className='infoDiv textSection button-box'>
            ...
            <Link to='/menu'>
              <Button
                size='sm'
                variant='success'
                style={{ backgroundColor: '#576D6B', border: 0 }}
              >
                Menu
              </Button>
            </Link>
